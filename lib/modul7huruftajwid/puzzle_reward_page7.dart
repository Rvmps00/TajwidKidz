...
class PuzzleRewardPage7 extends StatefulWidget {
  const PuzzleRewardPage7({super.key});

  @override
  State<PuzzleRewardPage7> createState() => _PuzzleRewardPage7State();
}

class _PuzzleRewardPage7State extends State<PuzzleRewardPage7> {
  ...
  final String puzzleKey = 'puzzle_solved_JamaMasjidDelhi';
  final String puzzleImagePath = 'assets/images/puzzle_modul/Jama-Masjid.png';
  final String puzzleName = 'Jama Masjid Delhi';
  final String puzzleLevel = 'Level 7 : Latihan Pengucapan Huruf dengan Hukum Tajwid';
  final String puzzleDescription =
      'Jama Masjid Delhi adalah salah satu masjid terbesar dan termegah di India, terletak di kota Delhi. Dibangun oleh Kaisar Mughal Shah Jahan pada abad ke-17, masjid ini dapat menampung lebih dari 25.000 jamaah. '
      'Dengan tiga kubah marmer dan dua menara tinggi, Jama Masjid merupakan contoh arsitektur Mughal yang megah dan menjadi pusat keagamaan penting di India.';
  ...
  if (correctPiecesCount == pieces.length) {
    ...
    await prefs.setBool('puzzle_solved_Jama-Masjid', true);
    setState(() => isSolved = true);

    // ✅ Simpan ke Firestore
    final user = FirebaseAuth.instance.currentUser;
    if (user != null) {
      final rewardId = 'Jama-Masjid';
