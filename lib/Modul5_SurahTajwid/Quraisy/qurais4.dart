...
class LearningQurais4Widget extends StatefulWidget {
  const LearningQurais4Widget({super.key});

  static String routeName = 'Learningqurais4';
  static String routePath = '/learningqurais4';

  @override
  State<LearningQurais4Widget> createState() => _LearningQurais4WidgetState();
}

class _LearningQurais4WidgetState extends State<LearningQurais4Widget> {
  ...
  late final AudioModel qurais4AudioModel;
  ...
  qurais4AudioModel = AudioModel(
    label: 'Quraisy4',
    fileName: 'Modul5/Al-Quraisy/Ayat 4.wav',
  );
  audioController = AudioController();

  // ✅ Preload audio di sini
  audioController.setSource(qurais4AudioModel.fileName);
  ...
  'Coba perhatikan pelafalan “min khawf”, karena bunyi ikhfanya belum terdengar samar. Latih agar transisi antara nun dan kha menjadi lembut.',
  'Ghunnah pada idgham di bagian “hum min” belum cukup terdengar. Pastikan kamu mendengungkan dengan cukup panjang dan jelas.',
  'Panjang mad pada “āmanahum” masih belum stabil. Latih agar aliran napas dan panjang harakat lebih konsisten.'
  ];

  final List<String> midFeedbacks = [
    'Pelafalanmu sudah cukup baik! Namun ghunnah pada bagian idgham masih bisa lebih terasa. Fokus pada dengungan di bagian "hum min".',
    'Coba jaga kestabilan panjang bacaan mad dan bunyi samar ikhfanya. Pelafalanmu sudah mendekati sempurna!',
    'Sudah bagus! Hanya perlu sedikit latihan pada bagian transisi “min khawf” agar ikhfanya terdengar lebih merata.'
  ];

  final List<String> highFeedbacks = [
    'Bacaanmu sangat baik! Ghunnah dan ikhfanya terdengar halus dan tepat. Panjang mad pun sudah sangat konsisten.',
    'MashaAllah! Pelafalan “min khawf” sangat lembut, dan mad pada “āmanahum” stabil serta enak didengar.',
    'Tajwid kamu untuk ayat ini sangat rapi. Ghunnah, ikhfa, dan mad semuanya dilafalkan dengan baik dan alami.'
  ];
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(builder: (context) => const LearningQurais3Widget()),
                            );
