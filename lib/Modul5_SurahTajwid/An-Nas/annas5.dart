...
class LearningAnnas5Widget extends StatefulWidget {
  ...
  static String routeName = 'Learningannas5';
  static String routePath = '/learningannas5';

  @override
  State<LearningAnnas5Widget > createState() => _LearningAnnas5WidgetState();
}

class _LearningAnnas5WidgetState extends State<LearningAnnas5Widget > {
  ...
  late final AudioModel annas5AudioModel;
  ...
  annas5AudioModel = AudioModel(
    label: 'Nas5',
    fileName: 'Modul5/An-Nas/Ayat 5.wav',
  );
  audioController = AudioController();

  // ✅ Preload audio di sini
  audioController.setSource(annas5AudioModel.fileName);
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningAnnas6Widget()),
                          );
                        },
                      ),
                    ],
