...
class LearningAlkausar1Widget extends StatefulWidget {
  ...
  static String routeName = 'Learningal_kausar1';
  static String routePath = '/learningl_kausar1';

  @override
  State<LearningAlkausar1Widget> createState() => _LearningAlkausar1WidgetState();
}
...
class _LearningAlkausar1WidgetState extends State<LearningAlkausar1Widget > {
  ...
  late final AudioModel kausar1AudioModel;
  ...
  kausar1AudioModel = AudioModel(
    label: 'Kausar1',
    fileName: 'Modul5/Al-Kausar/Ayat 1.wav',
  );
  audioController = AudioController();

  // ✅ Preload audio di sini
  audioController.setSource(kausar1AudioModel.fileName);
                        ...
                        onPressed: () async {
                          if (!isRecording) {
                            ...
                            final url = await _recordController.stopAndUpload(
                              currentAudio!,
                              folderPath: 'recordings/Module5/Al-Kausar',
                            );
