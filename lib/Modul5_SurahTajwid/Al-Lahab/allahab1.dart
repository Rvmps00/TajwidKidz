...
class LearningAllahab1Widget extends StatefulWidget {
  const LearningAllahab1Widget({super.key});

  static String routeName = 'Learningallahab1';
  static String routePath = '/learningallahab1';

  @override
  State<LearningAllahab1Widget> createState() => _LearningAllahab1WidgetState();
}

class _LearningAllahab1WidgetState extends State<LearningAllahab1Widget> {
  ...
  late final AudioModel allahab1AudioModel;
  ...
  allahab1AudioModel = AudioModel(
    label: 'Lahab1',
    fileName: 'Modul5/Al-Lahab/Ayat 1.wav',
  );
  audioController = AudioController();

  // ✅ Preload audio di sini
  audioController.setSource(allahab1AudioModel.fileName);
  ...
  final List<String> lowFeedbacks = [
    'Pantulan suara pada huruf qalqalah seperti "ba" masih terdengar kurang jelas. Cobalah untuk memberikan hentakan yang ringan tapi tegas saat membacanya.',
    'Panjang bacaan pada lafaz “yadaa” belum sesuai dengan mad thabi’i. Usahakan untuk memperpanjang vokalnya dengan stabil.',
    'Pengucapan pada bagian “tabbat” dan “watabba” perlu dilatih agar terasa mantap. Jangan terlalu cepat dan pastikan artikulasi tidak kabur.'
  ];

  final List<String> midFeedbacks = [
    'Bacaanmu cukup baik! Cobalah menambah sedikit kekuatan saat membunyikan huruf qalqalah agar lebih hidup.',
    'Mad thabi’i pada “yadaa” sudah bagus, hanya perlu sedikit ketenangan saat membacakan huruf akhir agar lebih stabil.',
    'Secara umum sudah bagus, tinggal menegaskan bagian qalqalah dan menjaga ritme di akhir bacaan.'
  ];

  final List<String> highFeedbacks = [
    'Bacaanmu sangat baik! Qalqalah dan mad terdengar pas dan alami. Irama bacaan pun terasa mantap dan jelas.',
    'MashaAllah! Pelafalanmu sudah fasih. Panjang pendek vokal dan hentakan qalqalah sesuai dengan kaidah tajwid.',
    'Pengucapanmu sudah tertata rapi dan stabil. Terus pertahankan kualitas bacaan seperti ini agar makin konsisten.'
  ];
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(builder: (context) => const LearningAllahab2Widget()),
                            );
                          },
                        ),
                      ],
