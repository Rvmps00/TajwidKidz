...
class LearningAllahab2Widget extends StatefulWidget {
  const LearningAllahab2Widget({super.key});

  static String routeName = 'Learningallahab2';
  static String routePath = '/learningallahab2';

  @override
  State<LearningAllahab2Widget> createState() => _LearningAllahab2WidgetState();
}

class _LearningAllahab2WidgetState extends State<LearningAllahab2Widget> {
  ...
  late final AudioModel allahab2AudioModel;
  ...
  allahab2AudioModel = AudioModel(
    label: 'Lahab2',
    fileName: 'Modul5/Al-Lahab/Ayat 2.wav',
  );
  audioController = AudioController();

  // ✅ Preload audio di sini
  audioController.setSource(allahab2AudioModel.fileName);
  ...
  final List<String> lowFeedbacks = [
    'Mad pada lafaz “maa” masih terdengar terlalu pendek. Pastikan kamu memperpanjang vokalnya selama dua harakat agar lebih sesuai.',
    'Bacaan ikhfaa pada bagian “`anhu” kurang halus. Cobalah latih transisi antara nun sukun dan huruf ha dengan lebih lembut.',
    'Artikulasi huruf-huruf akhir terdengar kurang tegas. Bacalah perlahan agar pengucapan setiap huruf tidak terpotong atau tergesa.'
  ];

  final List<String> midFeedbacks = [
    'Bacaanmu sudah cukup baik! Mad terdengar hampir sesuai, tinggal dijaga panjangnya agar tidak berubah-ubah.',
    'Transisi ikhfaa sudah mulai terdengar, tapi masih bisa ditingkatkan agar lebih lembut dan tidak terlalu jelas atau terlalu samar.',
    'Irama bacaan sudah baik, hanya saja beberapa bagian akhir ayat masih terdengar kurang stabil. Latih pelafalan akhir kalimat dengan tenang.'
  ];

  final List<String> highFeedbacks = [
    'MashaAllah! Bacaan mad dan ikhfaa kamu sudah sangat baik. Panjang vokal dan transisi suara terdengar halus dan jelas.',
    'Bacaanmu sangat fasih, terutama pada pelafalan “maa” dan “`anhu”. Penempatan tajwid tepat dan konsisten.',
    'Suara kamu sangat enak didengar. Mad dan ikhfaa sudah sesuai aturan dan dibaca dengan irama yang pas.'
  ];
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(builder: (context) => const LearningAllahab1Widget()),
                            );
                        ...
                        onPressed: () async {
                          if (!isRecording) {
                            ...
                            if (url != null) {
                              ...
                              if (result != null) {
                                final expectedRules = ['Mad', 'Ikhfaa']; // ✅ sesuaikan per ayat
                                final scores = {
                                  'Mad': result.mad,
