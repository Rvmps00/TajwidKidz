...
class _LearningAnnasr1WidgetState extends State<LearningAnnasr1Widget> {
  ...
  late final AudioModel annasr1AudioModel;
  ...
  annasr1AudioModel = AudioModel(
    label: 'Nasr1',
    fileName: 'Modul5/An-Nasr/Ayat 1.wav',
  );
  audioController = AudioController();

  // ✅ Preload audio di sini
  audioController.setSource(annasr1AudioModel.fileName);
  ...
  final List<String> lowFeedbacks = [
    'Pelafalan mad pada “jaa’a” terdengar terlalu cepat. Latih untuk menahan vokal panjang agar terdengar jelas dan tidak terburu-buru.',
    'Cobalah untuk memperjelas qalqalah pada huruf “ṣaad” di “naṣru”. Suaranya perlu dipantulkan dengan mantap, bukan diredam.',
    'Idgham syamsiyah pada “Allah” belum sempurna. Pastikan lam syamsiyah tidak dibaca, langsung masuk ke huruf lam dengan tegas.'
  ];

  final List<String> midFeedbacks = [
    'Kamu sudah cukup baik membaca mad panjang, namun bisa lebih stabil dan rata. Fokus pada ketahanan napas.',
    'Qalqalah pada “ṣaad” sudah terasa, tapi latih lagi agar tidak terlalu lemah dan tidak terlalu keras.',
    'Lam pada “Allah” sudah masuk, namun masih bisa lebih ditekankan agar terdengar tajwidnya lebih tegas dan fasih.'
  ];

  final List<String> highFeedbacks = [
    'MashaAllah! Bacaan mad dan idgham syamsiyahmu sangat baik, pelafalan huruf tajwid terdengar konsisten dan jelas.',
    'Bacaanmu sangat fasih. Qalqalah pada huruf “ṣaad” terdengar mantap, dan pelafalan “Allah” sangat tepat dan sesuai aturan.',
    'Tajwid pada ayat ini sudah sangat bagus! Kamu berhasil menggabungkan mad yang indah, qalqalah yang tepat, dan idgham yang halus.'
  ];
