...
class LearningAnnasr2Widget extends StatefulWidget {
  const LearningAnnasr2Widget({super.key});

  static String routeName = 'Learningannasr2';
  static String routePath = '/learningannasr2';

  @override
  State<LearningAnnasr2Widget> createState() => _LearningAnnasr2WidgetState();
}

class _LearningAnnasr2WidgetState extends State<LearningAnnasr2Widget> {
  ...
  late final AudioModel annasr2AudioModel;
  ...
  annasr2AudioModel = AudioModel(
    label: 'Nasr2',
    fileName: 'Modul5/An-Nasr/Ayat 2.wav',
  );
  audioController = AudioController();

  // ✅ Preload audio di sini
  audioController.setSource(annasr2AudioModel.fileName);
  ...
  'Perhatikan pelafalan “an-naas”, karena idgham syamsiyah pada huruf “nūn” masih terdengar belum menyatu dengan baik. Latih penggabungan yang lebih halus.',
  'Huruf qalqalah seperti “dal” dalam “yadkhuluuna” terdengar kurang mantap. Coba latih pantulan suaranya agar lebih tajam.',
  'Mad pada bacaan seperti “dīni” dan “Allāh” belum terasa cukup panjang. Fokus pada kestabilan vokal dan tarik napas lebih dalam sebelum membacanya.'
  ];

  final List<String> midFeedbacks = [
    'Bacaanmu sudah cukup baik, namun huruf “dal” dan “khaa” pada “yadkhuluuna” bisa lebih dipertegas pantulannya agar lebih hidup.',
    'Mad thabi’i pada “dīn” sudah terasa, tapi bisa lebih stabil dan rata. Hindari getaran suara yang membuat vokal tidak konsisten.',
    'Transisi idgham syamsiyah sudah cukup halus, tapi latih lagi agar penyatuan antara huruf tidak terdengar terputus.'
  ];

  final List<String> highFeedbacks = [
    'Bacaanmu terdengar sangat baik! Tajwid seperti mad, qalqalah, dan idgham syamsiyah sudah disampaikan dengan sangat fasih dan konsisten.',
    'MashaAllah! Kamu melafalkan “an-naas” dan “yadkhuluuna” dengan sangat tepat. Dengungan dan pantulan suaranya sudah sesuai.',
    'Selamat! Bacaanmu untuk ayat ini sangat bagus. Panjang mad stabil dan pelafalan huruf-huruf tajwid sangat rapi.'
  ];
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(builder: (context) => const LearningAnnasr1Widget()),
                            );
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(builder: (context) => const LearningAnnasr3Widget()),
                            );
                          },
                        ),
                      ],
                        ...
                        onPressed: () async {
                          if (!isRecording) {
                            ...
                            final url = await _recordController.stopAndUpload(
                              currentAudio!,
                              folderPath: 'recordings/Module5/An-Nasr',
                            );
