...
class LearningAlasr1Widget extends StatefulWidget {
  const LearningAlasr1Widget({super.key});

  static String routeName = 'Learningalasr1';
  static String routePath = '/learningalasr1';

  @override
  State<LearningAlasr1Widget> createState() => _LearningAlasr1WidgetState();
}

class _LearningAlasr1WidgetState extends State<LearningAlasr1Widget> {
  ...
  late final AudioModel alasr1AudioModel;
...
void initState() {
  ...
  alasr1AudioModel = AudioModel(
    label: 'Alasr1',
    fileName: 'Modul5/Al-Asr/Ayat 1.wav',
  );
  audioController = AudioController();

  // ✅ Preload audio di sini
  audioController.setSource(alasr1AudioModel.fileName);
  ...
  final List<String> lowFeedbacks = [
    'Perhatikan pengucapan huruf “ain” dan “shad” dalam “al-‘asr”. Kedua huruf ini termasuk huruf berat dan perlu pelafalan yang jelas dan mantap.',
    'Lam syamsiyah pada awal kata tidak boleh dilafalkan. Pastikan kamu langsung masuk ke huruf “‘ain” tanpa mengucapkan lam.',
    'Jika berhenti di akhir ayat, pastikan tidak terjadi hentakan yang berlebihan. Bacaan akhir harus terdengar lembut namun tegas.'
  ];

  final List<String> midFeedbacks = [
    'Pelafalanmu sudah cukup baik, terutama dalam membaca huruf tebal. Namun, lam syamsiyah masih perlu dilatih agar transisinya lebih mulus.',
    'Kamu sudah bisa membaca huruf “shad” dengan cukup kuat. Coba fokus juga pada artikulasi huruf “‘ain” agar lebih jelas terdengar.',
    'Secara keseluruhan sudah cukup baik, tapi pastikan akhir bacaan tidak terdengar tergesa atau mendadak berhenti.'
  ];

  final List<String> highFeedbacks = [
    'Pelafalan huruf-huruf berat seperti “shad” dan “‘ain” sangat bagus. Transisi dari lam syamsiyah ke huruf berikutnya juga terdengar alami.',
    'Bacaanmu stabil dan mantap. Kamu berhasil menyampaikan nuansa huruf tebal dan lembut secara seimbang dalam satu ayat pendek ini.',
    'Tajwidmu sangat baik untuk ayat ini! Pelafalan tajam namun tetap tenang pada akhir bacaan membuatnya terdengar khusyuk dan fasih.'
  ];
                        ...
                        onPressed: () async {
                          if (!isRecording) {
                            ...
                            final url = await _recordController.stopAndUpload(
                              currentAudio!,
                              folderPath: 'recordings/Module5/Al-Asr',
                            );
