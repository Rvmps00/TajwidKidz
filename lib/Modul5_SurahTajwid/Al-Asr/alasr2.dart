...
class LearningAlasr2Widget extends StatefulWidget {
  const LearningAlasr2Widget({super.key});

  static String routeName = 'Learningalasr2';
  static String routePath = '/learningalasr2';

  @override
  State<LearningAlasr2Widget> createState() => _LearningAlasr2WidgetState();
}

class _LearningAlasr2WidgetState extends State<LearningAlasr2Widget> {
  ...
  late final AudioModel alasr2AudioModel;
...
void initState() {
  ...
  final List<String> lowFeedbacks = [
    'Ghunnah pada bacaan “inna” dan “insaan” masih perlu dilatih. Pastikan kamu memberi cukup dengungan tanpa terlalu cepat atau terputus.',
    'Perhatikan pelafalan huruf “khaa” dalam “khusrin”. Huruf ini harus terdengar tebal dan keluar dari makhraj yang tepat.',
    'Lam qamariyah harus dibaca jelas. Jangan sampai terdengar seperti lam syamsiyah. Ulangi bagian “al-insaan” perlahan dan konsisten.'
  ];

  final List<String> midFeedbacks = [
    'Kamu sudah melafalkan ghunnah dengan cukup baik. Latih kembali agar suara dengungannya lebih stabil dan tidak berubah nada.',
    'Huruf-huruf berat seperti “khaa” terdengar cukup kuat. Namun, jaga keseimbangan suara agar tidak terlalu keras atau datar.',
    'Sudah baik, tapi kamu bisa meningkatkan kejelasan pelafalan pada huruf nun bertasydid agar ghunnah terdengar lebih penuh.'
  ];

  final List<String> highFeedbacks = [
    'Bacaanmu sangat bagus! Ghunnah dan huruf-huruf tebal seperti “khaa” terdengar jelas dan tajwidmu sangat baik.',
    'MashaAllah! Pengucapan “inna” dan “insaan” penuh dengungan yang tepat. Pelafalan “khusrin” pun kuat dan konsisten.',
    'Tajwid dalam ayat ini kamu kuasai dengan sangat baik. Dengungan, huruf qamariyah, dan huruf berat semua terdengar proporsional dan fasih.'
  ];
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(builder: (context) => const LearningAlasr1Widget()),
                            );
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(builder: (context) => const LearningAlasr3Widget()),
                            );
                          },
                        ),
                      ],
