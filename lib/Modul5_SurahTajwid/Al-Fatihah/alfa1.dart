...
class LearningAlfatihah1Widget extends StatefulWidget {
  ...
  static String routeName = 'LearningAlfa1';
  static String routePath = '/learningAlfa1';

  @override
  State<LearningAlfatihah1Widget> createState() => _LearningAlfatihah1WidgetState();
}

class _LearningAlfatihah1WidgetState extends State<LearningAlfatihah1Widget> {
  ...
  alfa1AudioModel = AudioModel(
    label: 'Alfa1',
    fileName: 'Modul5/Al-Fatihah/Ayat 1.wav',
  );
  audioController = AudioController();

  // ✅ Preload audio di sini
  audioController.setSource(alfa1AudioModel.fileName);
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningAlfatihah2Widget()),
                          );
                        },
                      ),
                    ],
                        ...
                        onPressed: () async {
                          if (!isRecording) {
                            ...
                            final url = await _recordController.stopAndUpload(
                              currentAudio!,
                              folderPath: 'recordings/Module5/Al-Fatihah',
                            );
