...
import 'al_ikhlas.dart'; // Import LearningAlIkhlasFullWidget
import 'al_ikhlas1.dart'; // Import LearningAlIkhlas1Widget
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      // Button for Learning Surah Al-Ikhlas
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) =>
                              const LearningAlIkhlasFullWidget(),
                            ),
                          );
                        },
                      ...
                      // Button for Learning Surah Al-Ikhlas 1
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                        ...
                        child: Row(
                          children: const [
                            ...
                            SizedBox(width: 5),
                            Text(
                              'Belajar Membaca Surah Al - Ikhlas',
                              style: TextStyle(
                                fontSize: 18, // Adjusted font size for consistency
                                color: Colors.black, // Text color set to black
                              ),
