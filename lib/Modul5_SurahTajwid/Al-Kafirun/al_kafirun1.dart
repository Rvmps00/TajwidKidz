...
class LearningAlkafirun1Widget extends StatefulWidget {
  const LearningAlkafirun1Widget ({super.key});

  static String routeName = 'Learningal_ikhlas1';
  static String routePath = '/learningal_ikhlas1';

  @override
  State<LearningAlkafirun1Widget> createState() => _LearningAlkafirun1WidgetState();
}

class _LearningAlkafirun1WidgetState extends State<LearningAlkafirun1Widget > {
  ...
  late final AudioModel kafirun1AudioModel;
  ...
  kafirun1AudioModel = AudioModel(
    label: 'Kafirun1',
    fileName: 'Modul5/Al-Kafirun/Ayat 1.wav',
  );
  audioController = AudioController();

  // ✅ Preload audio di sini
  audioController.setSource(kafirun1AudioModel.fileName);
  ...
  'Mad pada lafaz “yaa” masih terdengar kurang panjang. Usahakan memberikan cukup waktu pada harakat panjang agar tidak terdengar tergesa-gesa.',
  'Dengungan pada “ayyuhal” belum cukup stabil. Cobalah latih suara nasal agar tidak terlalu singkat atau tertahan.',
  'Perhatikan idgham syamsiyah saat mengucapkan “al-kaafiroon”, jangan beri jeda di antara alif lam dan huruf kaf.'
  ];

  final List<String> midFeedbacks = [
    'Bacaan kamu sudah cukup baik, namun mad pada “yaa” bisa diperpanjang sedikit lagi agar lebih sesuai dengan kaidah.',
    'Ghunnah sudah mulai terdengar, tapi perlu sedikit pelatihan agar tidak terdengar terlalu datar.',
    'Transisi antara “al” dan huruf kaf pada “al-kaafiroon” masih bisa diperhalus agar tidak terdengar terputus.'
  ];

  final List<String> highFeedbacks = [
    'MashaAllah! Mad dan ghunnah terdengar sangat alami. Pengucapan ayat pertama ini menunjukkan pemahaman tajwid yang baik.',
    'Bacaanmu mengalir dengan baik, dengan panjang pendek yang tepat dan artikulasi yang jelas.',
    'Tajwid seperti mad dan idgham pada ayat ini dilakukan dengan sangat baik. Terus lanjutkan latihan konsisten seperti ini.'
  ];
