...
import 'al_kafirun3.dart';
import 'al_kafirun5.dart';
...
class LearningAlkafirun4Widget extends StatefulWidget {
  const LearningAlkafirun4Widget ({super.key});

  static String routeName = 'Learningal_ikhlas4';
  static String routePath = '/learningal_ikhlas4';

  @override
  State<LearningAlkafirun4Widget> createState() => _LearningAlkafirun4WidgetState();
}

class _LearningAlkafirun4WidgetState extends State<LearningAlkafirun4Widget > {
  ...
  late final AudioModel kafirun4AudioModel;
  ...
  kafirun4AudioModel = AudioModel(
    label: 'Kafirun4',
    fileName: 'Modul5/Al-Kafirun/Ayat 4.wav',
  );
  audioController = AudioController();

  // ✅ Preload audio di sini
  audioController.setSource(kafirun4AudioModel.fileName);
  ...
  final List<String> lowFeedbacks = [
    'Coba latih kembali panjang mad di kata seperti “anaa” dan “maa”. Usahakan vokal panjang terdengar lebih stabil dan tidak terputus.',
    'Mim tasydid pada akhir bacaan belum terdengar cukup berdengung. Ulangi bacaan dengan menahan mim sejenak di hidung.',
    'Qalqalah pada huruf ba masih lemah. Latih pantulan suara agar terasa, namun tidak terlalu keras.'
  ];

  final List<String> midFeedbacks = [
    'Bacaanmu sudah mulai baik, tapi mad thabi’i masih perlu diperpanjang agar lebih sesuai kaidah tajwid.',
    'Dengungan pada mim tasydid sudah terdengar, namun perlu latihan agar lebih lembut dan tidak terputus.',
    'Qalqalah pada ba di “ʿabadtum” sudah muncul, pertahankan artikulasi dan perhatikan stabilitas suara.'
  ];

  final List<String> highFeedbacks = [
    'Bacaanmu luar biasa! Mad thabi’i di setiap lafaz terdengar alami dan dengungan mim tasydid sangat tepat.',
    'Kamu telah melafalkan huruf-huruf tajwid di ayat ini dengan sangat baik. Pantulan dan dengungan sudah sempurna!',
    'Irama bacaan, mad, dan dengungan kamu sangat terkontrol dan jelas. Teruskan latihan seperti ini, sangat bagus!'
  ];
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningAlkafirun3Widget()),
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) => const LearningAlkafirun5Widget()),
                          );
                        },
                      ),
                    ],
