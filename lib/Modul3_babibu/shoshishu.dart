...
class LearningShoShiShuWidget extends StatefulWidget {
  const LearningShoShiShuWidget ({super.key});

  static String routeName = 'Learningshoshishu';
  static String routePath = '/learningshoshishu';

  @override
  State<LearningShoShiShuWidget> createState() => _LearningShoShiShuWidgetState();
}

class _LearningShoShiShuWidgetState extends State<LearningShoShiShuWidget > {
  final TextEditingController _textController = TextEditingController();
  final FocusNode _textFieldFocusNode = FocusNode();

  int selectedIndex = 1; // Index for the BottomNavigationBar
  late final AudioModel shoshishuAudioModel;
  ...
  void initState() {
    ...
    shoshishuAudioModel = AudioModel(label: 'SHOSHISHU', fileName: 'Modul3/Sho Shi Shu.wav');
