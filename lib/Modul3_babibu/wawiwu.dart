...
class LearningWaWiWuWidget extends StatefulWidget {
  const  LearningWaWiWuWidget ({super.key});

  static String routeName = 'Learningnaninu';
  static String routePath = '/learningnaninu';

  @override
  State<LearningWaWiWuWidget > createState() => _LearningWaWiWuWidgetState();
}

class _LearningWaWiWuWidgetState extends State<LearningWaWiWuWidget>  {
  final TextEditingController _textController = TextEditingController();
  final FocusNode _textFieldFocusNode = FocusNode();

  int selectedIndex = 1; // Index for the BottomNavigationBar
  late final AudioModel wawiwuAudioModel;
  ...
  void initState() {
    ...
    wawiwuAudioModel = AudioModel(label: 'WAWIWU', fileName: 'Modul3/Wa Wi Wu.wav');
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningNaNiNuWidget()),
                          );
                        },
                      ),
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningHaHiHu1Widget()),
                          );
                        },
                      ),
                    ],
