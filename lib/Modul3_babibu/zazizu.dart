...
class LearningZaZiZuWidget extends StatefulWidget {
  const LearningZaZiZuWidget({super.key});

  static String routeName = 'Learningzazizu';
  static String routePath = '/learningzazizu';

  @override
  State<LearningZaZiZuWidget> createState() => _LearningZaZiZuWidgetState();
}

class _LearningZaZiZuWidgetState extends State<LearningZaZiZuWidget> {
  final TextEditingController _textController = TextEditingController();
  final FocusNode _textFieldFocusNode = FocusNode();

  int selectedIndex = 1; // Index for the BottomNavigationBar
  late final AudioModel zazizuAudioModel;
  ...
  void initState() {
    ...
    zazizuAudioModel = AudioModel(label: 'ZAZIZU', fileName: 'Modul3/Za Zi Zu.wav');
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningRaRiRuWidget()),
                          );
                        },
                      ),
                      IconButton(
