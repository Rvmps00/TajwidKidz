...
class LearningLaLiLuWidget extends StatefulWidget {
  const  LearningLaLiLuWidget({super.key});

  static String routeName = 'Learninglalilu';
  static String routePath = '/learninglalilu';

  @override
  State<LearningLaLiLuWidget> createState() => _LearningLaLiLuWidgetState();
}

class _LearningLaLiLuWidgetState extends State<LearningLaLiLuWidget>  {
  final TextEditingController _textController = TextEditingController();
  final FocusNode _textFieldFocusNode = FocusNode();

  int selectedIndex = 1; // Index for the BottomNavigationBar
  late final AudioModel laliluAudioModel;
  ...
  void initState() {
    ...
    laliluAudioModel = AudioModel(label: 'LALILU', fileName: 'Modul3/La Li Lu.wav');
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningKaKiKuWidget()),
                          );
                        },
                      ),
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningMaMiMuWidget()),
                          );
                        },
                      ),
                    ],
