...
class LearningRaRiRuWidget extends StatefulWidget {
  ...
  static String routeName = 'Learningrariru';
  static String routePath = '/learningrariru';

  @override
  State<LearningRaRiRuWidget> createState() => _LearningRaRiRuWidgetState();
}
...
class _LearningRaRiRuWidgetState extends State<LearningRaRiRuWidget> {
  ...
  late final AudioModel rariruAudioModel;
  ...
  void initState() {
    ...
    rariruAudioModel = AudioModel(label: 'RARIRU', fileName: 'Modul3/Ro Ri Ru.wav');
