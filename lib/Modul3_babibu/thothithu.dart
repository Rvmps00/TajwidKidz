...
class LearningThoThiThuWidget extends StatefulWidget {
  const LearningThoThiThuWidget ({super.key});

  static String routeName = 'Learningthothithu';
  static String routePath = '/learningthothithu';

  @override
  State<LearningThoThiThuWidget> createState() => _LearningThoThiThuWidgetState();
}

class _LearningThoThiThuWidgetState extends State<LearningThoThiThuWidget>  {
  final TextEditingController _textController = TextEditingController();
  final FocusNode _textFieldFocusNode = FocusNode();

  int selectedIndex = 1; // Index for the BottomNavigationBar
  late final AudioModel thothithuAudioModel;
  ...
  void initState() {
    ...
    thothithuAudioModel = AudioModel(label: 'THOTHITHU', fileName: 'Modul3/Tho Thi Thu.wav');
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningDhoDhiDhuWidget()),
                          );
                        },
                      ),
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningDzoDziDzuWidget()),
                          );
                        },
                      ),
                    ],
