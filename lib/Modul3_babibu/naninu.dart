...
class LearningNaNiNuWidget extends StatefulWidget {
  const  LearningNaNiNuWidget({super.key});

  static String routeName = 'Learningnaninu';
  static String routePath = '/learningnaninu';

  @override
  State<LearningNaNiNuWidget> createState() => _LearningNaNiNuWidgetState();
}

class _LearningNaNiNuWidgetState extends State<LearningNaNiNuWidget>  {
  final TextEditingController _textController = TextEditingController();
  final FocusNode _textFieldFocusNode = FocusNode();

  int selectedIndex = 1; // Index for the BottomNavigationBar
  late final AudioModel naninuAudioModel;
  ...
  void initState() {
    ...
    naninuAudioModel = AudioModel(label: 'NANINU', fileName: 'Modul3/Na Ni Nu.wav');
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningWaWiWuWidget()),
                          );
                        },
                      ),
                    ],
