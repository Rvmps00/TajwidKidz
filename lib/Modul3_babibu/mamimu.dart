...
class LearningMaMiMuWidget extends StatefulWidget {
  const  LearningMaMiMuWidget({super.key});

  static String routeName = 'Learningmamimu';
  static String routePath = '/learningmamimu';

  @override
  State<LearningMaMiMuWidget> createState() => _LearningMaMiMuWidgetState();
}

class _LearningMaMiMuWidgetState extends State<LearningMaMiMuWidget>  {
  final TextEditingController _textController = TextEditingController();
  final FocusNode _textFieldFocusNode = FocusNode();

  int selectedIndex = 1; // Index for the BottomNavigationBar
  late final AudioModel mamimuAudioModel;
  ...
  void initState() {
    ...
    mamimuAudioModel = AudioModel(label: 'MAMIMU', fileName: 'Modul3/Ma Mi Mu.wav');
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningLaLiLuWidget()),
                          );
                        },
                      ),
                      IconButton(
