...
class _LearningTsaTsiTsuWidgetState extends State<LearningTsaTsiTsuWidget> {
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningJaJiJuWidget()),
                          );
                        },
                      ),
                    ],
