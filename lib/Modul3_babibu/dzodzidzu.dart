...
class LearningDzoDziDzuWidget extends StatefulWidget {
  const LearningDzoDziDzuWidget({super.key});

  static String routeName = 'Learningdzodzidzu';
  static String routePath = '/learningdzodzidzu';

  @override
  State<LearningDzoDziDzuWidget> createState() => _LearningDzoDziDzuWidgetState();
}

class _LearningDzoDziDzuWidgetState extends State<LearningDzoDziDzuWidget> {
  final TextEditingController _textController = TextEditingController();
  final FocusNode _textFieldFocusNode = FocusNode();

  int selectedIndex = 1; // Index for the BottomNavigationBar
  late final AudioModel dzodzidzuAudioModel;
  ...
  void initState() {
    ...
    dzodzidzuAudioModel = AudioModel(label: 'DZODZIDZU', fileName: 'Modul3/Dzho Dzhi Dzhi.wav');
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.pushReplacement(
                              context,
                              MaterialPageRoute(builder: (context) => const LearningAinAIUWidget()),
                            );
                          },
                        ),
                      ],
