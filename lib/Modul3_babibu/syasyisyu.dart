...
class LearningSyaSyiSyuWidget extends StatefulWidget {
  const LearningSyaSyiSyuWidget  ({super.key});

  static String routeName = 'Learningsyasyisyu';
  static String routePath = '/learningsyasyisyu';

  @override
  State<LearningSyaSyiSyuWidget> createState() => _LearningSyaSyiSyuWidgetState();
}

class _LearningSyaSyiSyuWidgetState extends State<LearningSyaSyiSyuWidget > {
  final TextEditingController _textController = TextEditingController();
  final FocusNode _textFieldFocusNode = FocusNode();

  int selectedIndex = 1; // Index for the BottomNavigationBar
  late final AudioModel syasyisyuAudioModel;
  ...
  void initState() {
    ...
    syasyisyuAudioModel = AudioModel(label: 'SYASYISYU', fileName: 'Modul3/Sya Syi Syu.wav');
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningSaSiSuWidget()),
                          );
                        },
                      ),
                      IconButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => LearningShoShiShuWidget()),
                          );
                        },
                      ),
                    ],
