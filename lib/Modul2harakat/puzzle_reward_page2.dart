...
class PuzzleRewardPage2 extends StatefulWidget {
  const PuzzleRewardPage2({super.key});

  @override
  State<PuzzleRewardPage2> createState() => _PuzzleRewardPage2State();
}

class _PuzzleRewardPage2State extends State<PuzzleRewardPage2> {
  ...
  final String puzzleDescription =
      'Masjid Al-Aqsa adalah salah satu situs tersuci dalam agama Islam, terletak di Kota Tua Yerusalem, Palestina. Masjid ini merupakan masjid ketiga tersuci setelah Masjidil Haram di Mekah dan Masjid Nabawi di Madinah.';
