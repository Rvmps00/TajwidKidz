...
class PuzzleRewardPage4 extends StatefulWidget {
  const PuzzleRewardPage4({super.key});

  @override
  State<PuzzleRewardPage4> createState() => _PuzzleRewardPage4State();
}

class _PuzzleRewardPage4State extends State<PuzzleRewardPage4> {
  ...
  final String puzzleKey = 'puzzle_solved_MasjidAl-SalehSana`a';
  final String puzzleImagePath = 'assets/images/puzzle_modul/Masjid Sanaa.png';
  final String puzzleName = 'Masjid Al-Saleh Sana`a';
  final String puzzleLevel = 'Level 4 : Belajar Mengenal Tajwid';
  final String puzzleDescription =
      'Masjid Al-Saleh adalah masjid terbesar di Yaman, terletak di Sana’a. Diresmikan pada 2008, masjid ini menggabungkan arsitektur Islam tradisional dan modern, serta mampu menampung lebih dari 40.000 jamaah.';
  ...
  if (correctPiecesCount == pieces.length) {
    ...
    await prefs.setBool('puzzle_solved_Masjid Sanaa', true);
    setState(() => isSolved = true);

    // ✅ Simpan ke Firestore
    final user = FirebaseAuth.instance.currentUser;
    if (user != null) {
      final rewardId = 'Masjid Sanaa';
