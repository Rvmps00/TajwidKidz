import 'package:TajwidKidz/Modul6gharib/puzzle_reward_page6.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              onPressed: () {
                // Navigasi ke halaman puzzle khusus untuk level 6
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const PuzzleRewardPage6()),
                );
              },
            ),
          ],
...
class _BacaanGharibPageState extends State<BacaanGharibPage> {
  ...
  void _playPauseImalahAudio() async {
    if (_isPlayingImalah) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul6/imalah_majreha.mp3'));
    }
    setState(() {
  ...
  void _playPauseIsymamAudio() async {
    if (_isPlayingIsymam) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul6/isymam_laakmanna.mp3'));
    }
    setState(() {
  ...
  void _playPauseSaktahAudio() async {
    if (_isPlayingSaktah) {
      ...
      await _audioPlayer
          .play(AssetSource('audios/modul6/saktah_mimmarkodinahada.mp3'));
    }
    setState(() {
  ...
  void _playPauseSaktah2Audio() async {
    if (_isPlayingSaktah2) {
      ...
      await _audioPlayer
          .play(AssetSource('audios/modul6/saktah_alqiyamah2.mp3'));
    }
    setState(() {
  ...
  void _playPauseSaktah3Audio() async {
    if (_isPlayingSaktah3) {
      ...
      await _audioPlayer
          .play(AssetSource('audios/modul6/saktah_almuthafifinfull.mp3'));
    }
    setState(() {
  ...
  void _playPauseSaktah4Audio() async {
    if (_isPlayingSaktah4) {
      ...
      await _audioPlayer
          .play(AssetSource('audios/modul6/saktah_alkahfifull.mp3'));
    }
    setState(() {
  ...
  void _playPauseTashilAudio() async {
    if (_isPlayingTashil) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul6/tahsil_aajamiyu.mp3'));
    }
    setState(() {
  ...
  void _playPauseNaqlAudio() async {
    if (_isPlayingNaql) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul6/naql_hujurat.mp3'));
    }
    setState(() {
  ...
  void _playPauseBadalAudio() async {
    if (_isPlayingBadal) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul6/Badal_alahqaf.mp3'));
    }
    setState(() {
  ...
  void _playPauseMadQasrAudio() async {
    if (_isPlayingMadQasr) {
      ...
      await _audioPlayer
          .play(AssetSource('audios/modul6/madqasr_alkafirun4.mp3'));
    }
    setState(() {
  ...
  void _playPauseMalikAudio() async {
    if (_isPlayingMalik) {
      ...
      await _audioPlayer
          .play(AssetSource('audios/modul6/Malik_alfatihah.mp3'));
    }
    setState(() {
  ...
  void _playPauseDufAudio() async {
    if (_isPlayingDuf) {
      ...
      await _audioPlayer.play(AssetSource('audios/modul6/duf_arrum54.mp3'));
    }
    setState(() {
                  ...
                  content: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          'وَقِيلَ ٱرْكَبُواْ فِيهَا بِسْمِ ٱللَّهِ '
                  ...
                  content: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          'مَنْ بَعَثَنَا مِنْ مَّرْقَدِنَا ۜ هَٰذَا',
                          style: GoogleFonts.inter(
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          'كَلَّابَلۡ رَانَ عَلٰى قُلُوۡبِهِمۡ مَّا كَانُوۡا يَكۡسِبُوۡن',
                          style: GoogleFonts.inter(
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                      ...
                      const SizedBox(height: 20),
                      Text(
                        'Saktah antara: كَلَّا بَلۡ رَانٍَۙ',
                        style: GoogleFonts.inter(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                          color: Colors.red,
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          'اَ لۡحَمۡدُ لِلّٰهِ الَّذِىۡۤ اَنۡزَلَ عَلٰى عَبۡدِهِ الۡكِتٰبَ وَلَمۡ يَجۡعَلْ لَّهٗ عِوَجًا١',
                          style: GoogleFonts.inter(
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                  ...
                  content: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          'ءَؔاَعۡجَمِىٌّ وَّعَرَبِ  ؕ قُلۡ هُوَ لِلَّذِيۡنَ اٰمَنُوۡا هُدًى وَشِفَآءٌ  ؕ َ',
                          style: GoogleFonts.inter(
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                              _isPlayingNaql ? "Pause Audio" : "Putar Audio Naql"),
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFF8BC34A),
                            foregroundColor: Colors.white,
                            padding: const EdgeInsets.symmetric(
                  ...
                  content: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          'قُلۡ اَرَءَيۡتُمۡ مَّا تَدۡعُوۡنَ مِنۡ دُوۡنِ اللّٰهِ اَرُوۡنِىۡ مَاذَا خَلَقُوۡا مِنَ الۡاَرۡضِ اَمۡ لَهُمۡ شِرۡكٌ فِى السَّمٰوٰت اِیْتُوۡنِىۡ بِكِتٰبٍ مِّنۡ قَبۡلِ هٰذَاۤ اَوۡ'
                              'اَثٰرَةٍ مِّنۡ عِلۡمٍ اِنۡ كُنۡتُمۡ صٰدِقِيۡنَ',
                          style: GoogleFonts.inter(
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                  ...
                  content: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          'وَلَاۤ اَنَا عَابِدٌ مَّا عَبَدۡتُّم',
                          style: GoogleFonts.inter(
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                      ...
                      Align(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(_isPlayingMadQasr
                              ? "Pause Audio"
                              : "Putar Audio Mad & Qaṣr"),
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFF8BC34A),
                            foregroundColor: Colors.white,
                            padding: const EdgeInsets.symmetric(
                      ...
                      Padding(
                        ...
                        child: Text(
                          'Definisi:\n'
                              ...
                              'Contoh:\n'
                              'Kata: لَهُ\n'
                              'Dalam frasa: إِنَّهُ كَانَ بِهِ عَلِيمًا\n',
                          style: GoogleFonts.inter(
                              fontSize: 16, fontWeight: FontWeight.w500),
                        ),
                      ),
                  ...
                  content: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          '1. Malik\n'
                              'Surat Al-Fātiḥah: مٰلِكِ يَوۡمِ الدِّيۡن\ndibaca: Mālik atau Malik\n\n'
                              '2. Ḍuʿf\n'
                              'Surat Ar-Rūm ayat 54: اَللّٰهُ الَّذِىۡ خَلَقَكُمۡ مِّنۡ ضُعۡفٍ ثُمَّ جَعَلَ مِنۡۢ بَعۡدِ ضُعۡفٍ قُوَّةً ثُمَّ جَعَلَ مِنۡۢ بَعۡدِ قُوَّةٍ ضُعۡفًا وَّشَيۡبَةؕ يَخۡلُقُ مَا يَشَآءُ  وَهُوَ الۡعَلِيۡمُ الۡقَدِيۡر, \n '
                      ...
                      Container(
                        ...
                        padding: const EdgeInsets.all(8.0),
                        child: Text(
                          'اَللّٰهُ الَّذِىۡ خَلَقَكُمۡ مِّنۡ ضُعۡفٍ ثُمَّ جَعَلَ مِنۡۢ بَعۡدِ ضُعۡفٍ قُوَّةً ثُمَّ جَعَلَ مِنۡۢ بَعۡدِ قُوَّةٍ ضُعۡفًا وَّشَيۡبَةؕ يَخۡلُقُ مَا يَشَآءُ  وَهُوَ الۡعَلِيۡمُ الۡقَدِيۡر',
                          style: GoogleFonts.inter(
                            fontSize: 22,
                            fontWeight: FontWeight.bold,
                            color: Colors.black,
                      ...
                      Align(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                              _isPlayingDuf ? "Pause Audio" : "Putar Audio Ḍuʿf"),
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFF8BC34A),
                            foregroundColor: Colors.white,
                            padding: const EdgeInsets.symmetric(
