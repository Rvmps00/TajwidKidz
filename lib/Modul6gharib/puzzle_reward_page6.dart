...
class PuzzleRewardPage6 extends StatefulWidget {
  const PuzzleRewardPage6({super.key});

  @override
  State<PuzzleRewardPage6> createState() => _PuzzleRewardPage6State();
}

class _PuzzleRewardPage6State extends State<PuzzleRewardPage6> {
  ...
  final String puzzleKey = 'puzzle_solved_MasjidFaisal';
  final String puzzleImagePath = 'assets/images/puzzle_modul/Masjid Faisal.png';
  final String puzzleName = 'Masjid Faisal';
  final String puzzleLevel = 'Level 6 : Belajar Mengenal Gharib';
  final String puzzleDescription =
      'Masjid Faisal adalah masjid terbesar di Pakistan, terletak di Islamabad. Dibangun dengan bantuan Raja Faisal '
      'dari Arab Saudi, masjid ini memiliki desain unik seperti tenda Badui, berbeda dari masjid tradisional. Dirancang '
      'oleh arsitek Turki Vedat Dalokay, masjid ini dapat menampung lebih dari 100.000 jamaah dan menjadi simbol persahabatan antara Pakistan dan Arab Saudi.';
  ...
  if (correctPiecesCount == pieces.length) {
    ...
    await prefs.setBool('puzzle_solved_Masjid Faisal', true);
    setState(() => isSolved = true);

    // ✅ Simpan ke Firestore
    final user = FirebaseAuth.instance.currentUser;
    if (user != null) {
      final rewardId = 'Masjid Faisal';
